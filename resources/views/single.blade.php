...
@section('page-title', $comics[$id]['title'])
            ...
            <div class="row my-3 bg-success-subtle border-1 border-bottom border-secondary">
                ...
                <div class="col-3 right-info border-1 border-start border-secondary">
                    <div class="dropdown text-center">
                        <button class="btn text-white dropdown-toggle" type="button" id="triggerId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Check Availability
                        </button>
        ...
        <div class="row row-cols-2 py-5">
            <div class="col">
                ...
                <div class="artist d-flex border-1 border-top border-secondary py-3">
                    ...
                    <div class="col-9">
                        <p class="text-primary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit ipsa necessitatibus possimus, tenetur ipsum nesciunt voluptatum harum consequuntur perspiciatis illo excepturi, quibusdam explicabo ab adipisci quisquam modi atque? Tenetur, debitis.</p>
                    </div>
                </div>
                <div class="writer d-flex border-1 border-top border-bottom border-secondary py-3">
                    ...
                    <div class="col-9">
                        <p class="text-primary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore eius laboriosam vero fugit, mollitia voluptates ea maxime nostrum omnis? Mollitia necessitatibus hic architecto repudiandae eaque aperiam temporibus quaerat fuga voluptatum.</p>
                    </div>
                </div>
            </div>
            <div class="col">
    ...
    <div class="container">
        <div class="row row-cols-4">
            <div class="col d-flex justify-content-between pt-3 border-1 border-start border-secondary">
                ...
                <img src="{{Vite::asset('resources/images/img/buy-comics-digital-comics.png')}}" alt="" style="background-color:gray; height:50%; padding: 0 1rem;">
            </div>
            <div class="col d-flex justify-content-between pt-3 border-1 border-start border-secondary">
                <h4>SHOP DC</h4>
                <img src="{{Vite::asset('resources/images/img/buy-comics-subscriptions.png')}}" alt="" style="background-color:gray; height:50%; padding: 0 1rem;">
            </div>
            <div class="col d-flex justify-content-between pt-3 border-1 border-start border-secondary">
                <h4>COMIC SHOP LOCATOR</h4>
                <img src="{{Vite::asset('resources/images/img/buy-comics-shop-locator.png')}}" alt="" style="background-color:gray; height:50%; padding: 0 1rem;">
            </div>
            <div class="col d-flex justify-content-between pt-3 border-1 border-start border-end border-secondary">
                <h4>SUBSCRPTIONS</h4>
                <img src="{{Vite::asset('resources/images/img/buy-comics-merchandise.png')}}" alt="" style="background-color:gray; height:50%; padding: 0 1rem;">
            </div>
        </div>
    </div>
</div>
